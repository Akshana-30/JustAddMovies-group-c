...
export default async function AdminPage() {
  ...
  for (let i = 5; i >= 0; i--) {
    ...
    const label = d.toLocaleString("en-SE", {
      month: "short",
      year: "2-digit",
    });
    const oldRevenue = allOrders
      .filter((o) => {
  ...
  const stats = [
    {
      ...
      emoji: "💰",
      color: "var(--gold)",
      href: "/admin-dashboard/admin/orders",
    },
    {
      label: "Customers",
      value: customerCount,
      emoji: "👥",
      color: "#60a5fa",
      href: "/admin-dashboard/admin/customers",
    },
    {
      label: "Total Orders",
      value: orderCount,
    ...
    },
    {
      ...
      value: `${formatPrice(avgSalePrice)}`,
      emoji: "🏷",
      color: "#f472b6",
      href: "#",
    },
              ...
              {recentOrders.map((order) => (
                ...
                >
                  ...
                  >
                    {order.orderItem
                      .reduce(
                        (s, i) => s + (i.priceAtPurchase * i.quantity) / 100,
                        0,
                      )
                  ...
                  <td style={{ padding: "12px 16px" }}>
                    <span
                      style={{
                        ...
                        color:
                          order.status === "PAID" ? "#4ade80" : "var(--gold)",
                      }}
                    >
                      {order.status}
                    </span>
