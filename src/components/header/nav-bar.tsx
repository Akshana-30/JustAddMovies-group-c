  ...
  return (
    <nav className="navbar py-2 flex items-center md-20">
      ...
      <HamburgerButton>
        <ul className="flex flex-col gap-4">
          <li>
            <Button
              asChild
              variant="ghost"
              className="text-sidebar-accent-foreground text-[clamp(1.2rem,3vw,1.5rem)]"
              size="lg"
            >
              <Link href="/">
                {" "}
          ...
          <li className="text-sidebar-accent-foreground ml-auto mr-2 w-[clamp(190px,50%,220px)]">
            <InputGroup className="rounded-2xl">
              <InputGroupInput className="text-[clamp(0.8rem,1vw,1.5rem)]" placeholder="Search..." />
          ...
          <Separator className="data-[orientation=horizontal]:w-[clamp(270px,100%,100%)] my-4 ml-auto" />
        ...
        <ul className="ml-auto mr-2 flex gap-3">
          <li>
            <Button
              asChild
              variant="outline"
              className="h-[clamp(0.5rem,6vw,2.3rem)]! w-[clamp(0.5rem,6vw,2.3rem)]! text-sidebar-accent-foreground"
              size="icon-lg"
            >
              <Link href="/cart" className="px-0 items-center relative">
                <svg
